...
- 2026-07-02 — §5 wrap animation built (Code, user-directed): rotate now animates as a FLIP flight — dice slide one column, the wrapper arcs over the row. Debt line rewritten as as-built.
